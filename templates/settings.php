<div class="wrap">
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
          <th scope="row"><label><h3><?php _e('Section','odi') ?></h3></label></th>
          <tr valign="top">
              <th scope="row"><label for="wpdash_setting_1"><?php _e('Dummy setting','odi') ?></label></th>
              <td>
                <input class="full-width" type="text" name="wpdash_setting_1" id="wpdash_setting_1" value="<?php echo $setting_1 ?>"/>
                <p class="description"><?php _e('Modify according to needs','odi') ?>.</p>
              </td>
          </tr>
        </table>
        <?php @submit_button(); ?>
